...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_WORK_BACKGROUND=176
  typeset -g POWERLEVEL9K_DIR_WORK_FOREGROUND=236
  ...
  typeset -g POWERLEVEL9K_TERRAFORM_PROD_BACKGROUND=8
  typeset -g POWERLEVEL9K_TERRAFORM_STAGING_BACKGROUND=16
  typeset -g POWERLEVEL9K_TERRAFORM_STAGING_FOREGROUND=8
  typeset -g POWERLEVEL9K_TERRAFORM_DEFAULT_FOREGROUND=254
  typeset -g POWERLEVEL9K_TERRAFORM_DEFAULT_BACKGROUND=8
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_STAGING_BACKGROUND=16
  typeset -g POWERLEVEL9K_KUBECONTEXT_STAGING_FOREGROUND=8
  ...
  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='asp|aws|awless|cdk|terraform|pulumi|terragrunt'
  ...
  typeset -g POWERLEVEL9K_AWS_PROD_BACKGROUND=8
  typeset -g POWERLEVEL9K_AWS_PROD_CONTENT_EXPANSION='! ${P9K_CONTENT} !'
  typeset -g POWERLEVEL9K_AWS_STAGING_FOREGROUND=16
  typeset -g POWERLEVEL9K_AWS_STAGING_BACKGROUND=8
  typeset -g POWERLEVEL9K_AWS_DEV_FOREGROUND=2
  typeset -g POWERLEVEL9K_AWS_DEV_BACKGROUND=8
  typeset -g POWERLEVEL9K_AWS_DEFAULT_FOREGROUND=254
  typeset -g POWERLEVEL9K_AWS_DEFAULT_BACKGROUND=8
